...
\begin{tad}{\tadNombre{Mapa}}
    ...
    \tadOperacion{movimientoInvalido}{Coordenada/c1, Coordenada/c2, Mapa/m}{bool}{{c1,c2} $\subseteq$ posiciones(m)}{}
    \tadOperacion{distancia}{Coordenada/c1, Coordenada/c2}{Nat}{}{}
    \tadOperacion{estaEnElMismoRango}{Coordenada/c1, Coordenada/c2}{bool}{}{}
	...
	\tadAxioma{movimientoInvalido(c1, c2, m)}{distancia(c1,c2) $\geq$ 10 $\lor$ !existenCaminos(c1,c2,m) }
	...
	\tadAxioma{estaEnElMismoRango(c1, c2)}{ distancia(c1,c2) $\leq$ 5 * 5}
