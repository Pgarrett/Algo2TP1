...
\begin{tad}{\tadNombre{Juego}}
	...
	\tadAxioma{pokemones(informarPosicion(j, c, pGo))}{\IF nula?(c) THEN pokemones(pGo) ELSE {\IF (posicionInvalida(posicionJugador(j, pGo), c, pGo) $\land$ cantidadSanciones(j) = 4) THEN borrarPokemones(pokemones(pGo), claves(pokedex(j))) FI} ELSE pokemones(pGo) FI}
