...
%
  ...
  \tadAxioma{esSalvaje(id, pGo)}{esSalvajeAux(id, claves(jugadores(pGo)), pGo} 
  
    \tadAxioma{esSalvajeAux(id,jugadores, pGo)}{{{\IF vacio?(jugadores) THEN false ELSE {\IF definido?(id,pokemonesAtrapados(dameUno(jugadores),pGo)) THEN true ELSE esSalvajeAux(id,sinUno(jugadores),pGo) FI} FI}} }
