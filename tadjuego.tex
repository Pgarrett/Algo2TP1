...
\begin{tad}{\tadNombre{Juego}}
    ...
    %%% Otras Operaciones %%%
    \tadOtrasOperaciones
    \tadAlinearFunciones{estaEnElRangoDeOtroPokemon~}{Pokemon/p, Jugador/j, Juego/pGo, Juego}
...
%	\tadOperacion{posicionJugadores}{Coordenada/c, Juegao/pGo}{conj(Jugador)}{c $\in$ posiciones(mapa(pGo))}  
    ...
    \tadOperacion{estaEnElRangoDeOtroPokemon}{Coordenada/c1, Coordenada/c2}{Bool}{}
    \tadOperacion{restaAbsoluta}{Nat/n1, Nat/n2}{Nat}{}
    \tadOperacion{rareza}{Tipo/t, Juego/pGo}{Nat}{}        
    \tadOperacion{cantidadPokemonesTipo}{Tipo/t, Conj(Nat)/ids, Juego/pGo}{Nat}{}
...
%
  ...
  \tadAxioma{rareza(t, pGo)}{100 - (cantidadPokemones(t, dividir(claves(pokemones(pGo)), pGo), \#claves(pokemones(pGo)))) * 100}
